...
public class updateFlight extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        fb.setAvailableDay(availableDay);
        fb.setDepartTime(departTime);
        fb.setNoOfSeats(noOfSeats);
        
        if(fb.updateFlight(flightID, destination, availableDay, departTime, noOfSeats)) {
            response.sendRedirect("viewFlights");
        }
        else {
            out.println("Flight details of Flight "+flightID+" could not be updated.");
        }
    }
