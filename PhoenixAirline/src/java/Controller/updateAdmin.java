...
public class updateAdmin extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(updateField.equals("adminPassword")) {
            ...
            if(ab.updateAdminPassword(adminEmail, adminPassword)) {
        ...
        if(updateField.equals("adminGender")) {
            ...
            if(ab.updateAdminGender(adminEmail, adminGender)) {
                out.println("Your gender was successfully updated. Log in to continue");
                RequestDispatcher rd = request.getRequestDispatcher("./loginAdmin.jsp");
                response.setContentType("text/html; charset='UTF-8'");
                rd.include(request, response);
            }
        ...
        if(updateField.equals("adminName")) {
            ...
            if(ab.updateAdminName(adminEmail, adminName)) {
                out.println("Your name was successfully updated. Log in to continue");
                RequestDispatcher rd = request.getRequestDispatcher("./loginAdmin.jsp");
                response.setContentType("text/html; charset='UTF-8'");
                rd.include(request, response);
            }
        ...
        if(updateField.equals("adminTel")) {
            ...
            if(ab.updateAdminTel(adminEmail, adminTel)) {
                out.println("Your contact number password was successfully updated. Log in to continue");
                RequestDispatcher rd = request.getRequestDispatcher("./loginAdmin.jsp");
                response.setContentType("text/html; charset='UTF-8'");
                rd.include(request, response);
            }
        ...
        if(updateField.equals("profilePhoto")) {
            ...
            if(ab.updateProfilePhoto(adminEmail, profilePhoto)) {
